...
dependencies {
    ...
    implementation("com.kotlindiscord.kord.extensions:kord-extensions:1.4.0-RC3")
    implementation("com.kotlindiscord.kordex.ext.mappings:ext-mappings:1.0.0-SNAPSHOT")
